  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="javascript:eliminar(<?php echo $tipoTercero->id ?>,'<?php echo $fsConfig->getUrl() ?>index.php/tipoTercero/eliminar')" type="button" class="btn btn-danger">Eliminar</a>
      </div>
    </div>
  </div>
</div>